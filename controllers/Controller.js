  ...
  static collectRequestParams(request) {
    ...
    request.openapi.schema.parameters.forEach((param) => {
      if (param.in === 'path') {
        ...
        requestParams[param.name] = request.body[param.name];
      }
    });
    // handle bug with generator assigning to requestParams.body, but limiting object scope via service call with { arg }
    // probably not great since this could clobber named parameters that match body names.
